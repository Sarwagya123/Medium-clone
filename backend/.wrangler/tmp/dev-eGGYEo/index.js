...
// .wrangler/tmp/bundle-eygc93/checked-fetch.js
  ...
  "node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "D:\\My Projects\\MERN Projects\\Medium web-app\\backend\\node_modules\\@prisma\\client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
...
// .wrangler/tmp/bundle-eygc93/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-eygc93/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
blogRouter.get("/bulk", async (c) => {
  ...
  try {
    ...
    c.status(411);
    return c.json({
      err: "Error while fetching all blogs"
    });
  }
});
